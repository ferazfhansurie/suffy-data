...
var css_248z$3 = ".EmojiPickerReact .Flex{display:flex}.EmojiPickerReact .Flex.FlexRow{flex-direction:row}.EmojiPickerReact .Flex.FlexColumn{flex-direction:column}";
...
var css_248z$4 = ".EmojiPickerReact .epr-preview{align-items:center;border-top:1px solid var(--epr-preview-border-color);height:var(--epr-preview-height);padding:0 var(--epr-horizontal-padding);position:relative;z-index:1;z-index:var(--epr-preview-z-index)}.EmojiPickerReact .epr-preview .epr-preview-emoji-label{color:var(--epr-preview-text-color);font-size:var(--epr-preview-text-size);padding:var(--epr-preview-text-padding);text-transform:capitalize}";
...
var css_248z$7 = ".EmojiPickerReact .epr-header .epr-header-overlay{padding:var(--epr-header-padding);z-index:var(--epr-header-overlay-z-index)}";
...
function PickerRootElement(_ref2) {
  ...
  return createElement("aside", {
    className: cx(styles$2.main, (_cx = {}, _cx[ClassNames.searchActive] = searchModeActive, _cx[ClassNames.darkTheme] = theme === Theme.DARK, _cx[ClassNames.autoTheme] = theme === Theme.AUTO, _cx), className),
    ref: PickerMainRef,
    style: style
  }, children);
}
