...
function ClickableEmojiButton(_ref) {
  ...
  return createElement(Button, {
    className: cx(ClassNames.emoji, (_cx = {}, _cx[ClassNames.hidden] = hidden, _cx[ClassNames.hiddenOnSearch] = hiddenOnSearch, _cx[ClassNames.visible] = !hidden && !hiddenOnSearch, _cx[ClassNames.emojiHasVariations] = hasVariations && showVariations, _cx)),
...
function EmojiCategory(_ref) {
  ...
  return createElement("li", {
    className: cx(ClassNames.category, (_cx = {}, _cx[ClassNames.hidden] = hidden, _cx[ClassNames.hiddenOnSearch] = hiddenOnSearch, _cx)),
    "data-name": category,
...
var css_248z$4 = ".EmojiPickerReact .Flex{display:flex}.EmojiPickerReact .Flex.FlexRow{flex-direction:row}.EmojiPickerReact .Flex.FlexColumn{flex-direction:column}";
...
function Flex(_ref) {
  ...
  return createElement("div", {
    ...
    className: cx('Flex', className, direction)
  }, children);
}
...
var css_248z$5 = ".EmojiPickerReact .epr-preview{align-items:center;border-top:1px solid var(--epr-preview-border-color);height:var(--epr-preview-height);padding:0 var(--epr-horizontal-padding);position:relative;z-index:1;z-index:var(--epr-preview-z-index)}.EmojiPickerReact .epr-preview .epr-preview-emoji-label{color:var(--epr-preview-text-color);font-size:var(--epr-preview-text-size);padding:var(--epr-preview-text-padding);text-transform:capitalize}";
...
var css_248z$a = "aside.EmojiPickerReact.epr-main{border-color:var(--epr-picker-border-color);border-radius:var(--epr-picker-border-radius);border-style:solid;border-width:1px;display:flex;flex-direction:column;position:relative}";
