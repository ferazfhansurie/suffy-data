...
function Body() {
  ...
  useOnMouseMove();
  return React.createElement("div", {
    className: flairup.cx(styles.body),
    ref: BodyRef
...
function PickerRootElement(_ref2) {
  ...
  return React.createElement("aside", {
    className: flairup.cx(ClassNames.emojiPicker, 'epr-main', (_cx = {}, _cx[ClassNames.searchActive] = searchModeActive, _cx[ClassNames.darkTheme] = theme === exports.Theme.DARK, _cx[ClassNames.autoTheme] = theme === exports.Theme.AUTO, _cx), className),
    ref: PickerMainRef,
    style: style
  }, children);
}
