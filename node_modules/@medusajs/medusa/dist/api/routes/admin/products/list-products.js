...
exports.AdminGetProductsParams = exports.listAndCountProductWithIsolatedProductModule = void 0;
...
function getVariantsFromPriceList(req, priceListId) {
    var _a;
    return __awaiter(this, void 0, void 0, function () {
        var remoteQuery, pricingModuleService, productModuleService, _b, priceList, priceSetIds, query, variantPriceSets, variantIds;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    remoteQuery = req.scope.resolve("remoteQuery");
                    pricingModuleService = req.scope.resolve("pricingModuleService");
                    productModuleService = req.scope.resolve("productModuleService");
                    return [4 /*yield*/, pricingModuleService.listPriceLists({ id: [priceListId] }, {
                            relations: [
                ...
                case 1:
                    _b = __read.apply(void 0, [_c.sent(), 1]), priceList = _b[0];
                    priceSetIds = (_a = priceList.price_set_money_amounts) === null || _a === void 0 ? void 0 : _a.map(function (psma) { var _a; return (_a = psma.price_set) === null || _a === void 0 ? void 0 : _a.id; });
                    query = {
                ...
                case 2:
                    variantPriceSets = _c.sent();
                    variantIds = variantPriceSets.map(function (vps) { return vps.variant_id; });
                    return [4 /*yield*/, productModuleService.listVariants({
                            id: variantIds,
                        }, {
                            select: ["product_id"],
                        })];
...
function listAndCountProductWithIsolatedProductModule(req, filterableFields, listConfig) {
    return __awaiter(this, void 0, void 0, function () {
        var remoteQuery, featureFlagRouter, productIdsFilter, variantIdsFilter, promises, salesChannelIdFilter, salesChannelService, priceListId, variants, priceListService, discountConditionId, variables, query, _a, products, count;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    if (!featureFlagRouter.isFeatureEnabled(utils_1.MedusaV2Flag.key)) return [3 /*break*/, 2];
                    return [4 /*yield*/, getVariantsFromPriceList(req, priceListId)];
                case 1:
                    variants = _b.sent();
...
exports.listAndCountProductWithIsolatedProductModule = listAndCountProductWithIsolatedProductModule;
/**
