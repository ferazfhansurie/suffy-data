                            ...
                            case 5:
                                if (priceListsToCreate.length) {
                                    promises.push(pricingModuleService.createPriceLists(priceListsToCreate.map(function (_a) {
                                        ...
                                        var createData = __assign(__assign({}, priceList), { starts_at: (_b = priceList.starts_at) === null || _b === void 0 ? void 0 : _b.toISOString(), ends_at: (_c = priceList.ends_at) === null || _c === void 0 ? void 0 : _c.toISOString(), title: title });
