                        ...
                        return [4 /*yield*/, this.atomicPhase_(function (transactionManager) { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_c) {
                                    switch (_c.label) {
                                        ...
                                        case 17:
                                            _c.sent();
                                            if (!((_b = cart.shipping_methods) === null || _b === void 0 ? void 0 : _b.length)) return [3 /*break*/, 19];
                                            return [4 /*yield*/, this.shippingOptionService_
                                                    .withTransaction(transactionManager)
                                                    .deleteShippingMethods(cart.shipping_methods)];
                                        case 18:
    ...
    CartService.prototype.updateLineItem = function (cartId, lineItemId, lineItemUpdate) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.atomicPhase_(function (transactionManager) { return __awaiter(_this, void 0, void 0, function () {
                            var select, cart, lineItem, hasInventory, updatedCart;
                            var _a;
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                    ...
                                    case 3:
                                        ...
                                        _b.label = 4;
                                    case 4:
                                        if (!((_a = cart.shipping_methods) === null || _a === void 0 ? void 0 : _a.length)) return [3 /*break*/, 6];
                                        return [4 /*yield*/, this.shippingOptionService_
                                                .withTransaction(transactionManager)
                                                .deleteShippingMethods(cart.shipping_methods)];
                                    case 5:
                            ...
                            return __generator(this, function (_f) {
                                switch (_f.label) {
                                    ...
                                    case 6:
                                        ...
                                        _f.label = 7;
                                    case 7:
                                        if (!((0, medusa_core_utils_1.isDefined)(data.region_id) && cart.region_id !== data.region_id)) return [3 /*break*/, 9];
