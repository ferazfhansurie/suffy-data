...
exports.MikroOrmBaseTreeRepository = exports.MikroOrmBaseRepository = exports.MikroOrmAbstractTreeRepositoryBase = exports.MikroOrmAbstractBaseRepository = exports.MikroOrmBase = void 0;
...
var MikroOrmAbstractBaseRepository = /** @class */ (function (_super) {
    ...
    MikroOrmAbstractBaseRepository.prototype.softDelete = function (idsOrFilter, _a) {
        var _b = _a === void 0 ? {} : _a, manager = _b.transactionManager;
        return __awaiter(this, void 0, void 0, function () {
            var isArray, filter, entities, date, softDeletedEntitiesMap;
                ...
                switch (_c.label) {
                    case 0:
                        ...
                        filter = isArray || (0, common_1.isString)(idsOrFilter)
                            ...
                            : idsOrFilter;
                        return [4 /*yield*/, this.find({ where: filter })];
                    case 1:
                        entities = _c.sent();
                        date = new Date();
    ...
    MikroOrmAbstractBaseRepository.prototype.restore = function (idsOrFilter, _a) {
        var _b = _a === void 0 ? {} : _a, manager = _b.transactionManager;
        return __awaiter(this, void 0, void 0, function () {
            var isArray, filter, query, entities, softDeletedEntitiesMap;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        isArray = Array.isArray(idsOrFilter);
    ...
    MikroOrmAbstractBaseRepository.prototype.applyFreeTextSearchFilters = function (findOptions, retrieveConstraintsToApply) {
