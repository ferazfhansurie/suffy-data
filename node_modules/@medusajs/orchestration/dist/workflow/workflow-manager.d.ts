...
export declare class WorkflowManager {
    ...
    static register(workflowId: string, flow: TransactionStepsDefinition | OrchestratorBuilder | undefined, handlers: WorkflowHandler, requiredModules?: Set<string>, optionalModules?: Set<string>): void;
