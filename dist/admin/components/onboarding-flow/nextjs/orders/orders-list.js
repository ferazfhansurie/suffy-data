...
const OrdersListNextjs = ({ isComplete, data }) => {
    ...
    const [cartId, setCartId] = (0, react_1.useState)(null);
    const prepareNextjsCheckout = async () => {
        ...
        try {
            ...
            setCartId(cart === null || cart === void 0 ? void 0 : cart.id);
        }
        catch (e) {
            console.error(e);
        }
